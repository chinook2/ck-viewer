Ext.define('Ck._Lang', {
	...
	strings: {
        'en': {
			...
			'import_shp_error_pattern': 'No Polygon shapefile found with name starting by "Parcel_"',
			'import_shp_error_pattern_point': 'No Point shapefile found with name starting by "Parcel_bor"',
        ...
        'fr': {
			...
			'import_shp_error_pattern': 'Aucun shapefile de polygone trouvé avec le nom commençant par "Parcel_"',
			'import_shp_error_pattern_point': 'Aucun shapefile de point trouvé avec le nom commençant par "Parcel_bor"',
