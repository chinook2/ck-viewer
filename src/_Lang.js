	...
	strings: {
        'en': {
			...
			'import_shp_help_text_parcel': ['Please upload a Parcel Shapefile as ZIP',
				...
				' - The "shapefile_name" shall start by "Parcel_" for the polygon.',
				' - The "shapefile_name" shall start by "Parcel_bor_" for the points.',
			...
			'import_shp_help_text': ['Please upload a Village Shapefile as ZIP',
				'Zip archive must contain 2 shapefiles, 1 for polygon and 1 for points (without folder):',
				' - The "shapefile_name" shall start by "Terroir_{name of the village}" for the polygon.',
				' - The "shapefile_name" shall start by "Terroir_bor_{name of the village}" for the points.',
				' - For each shapefile, the 4 extensions files shall be present: ".shp", ".dbf", ".prj", ".shx".',
				'Projection can be one of the following:',
				' - WGS84 / UTM Zone 30N (EPSG:32630)',
				' - WGS84 / UTM Zone 29N (EPSG:32629)'
			...
			'import_shp_error_pattern_parcel': 'No Polygon shapefile found with name starting by "Parcel_"',
			'import_shp_error_pattern_parcel_point': 'No Point shapefile found with name starting by "Parcel_bor"',
			'import_shp_error_pattern_village': 'No Polygon shapefile found with name starting by "Terroir_"',
			'import_shp_error_pattern_village_point': 'No Point shapefile found with name starting by "Terroir_bor"',
        ...
        'fr': {
			...
			'import_shp_help_text_parcel': ['Veuillez téléverser un Shapefile de Parcelle en archive ZIP',
				...
				' - Le nom du shapefile doit commencer par "Parcel_" pour le polygone',
				' - Le nom du shapefile doit commencer par "Parcel_bor" pour les points',
			...
			'import_shp_help_text_village': ['Veuillez téléverser un Shapefile de Village en archive ZIP',
				"L'archive Zip doit contenir 2 shapefiles, 1 pour le polygone et 1 pour les points (sans dossier):",
				' - Le nom du shapefile doit commencer par "Terroir_" pour le polygone',
				' - Le nom du shapefile doit commencer par "Terroir_bor" pour les points',
				' - Pour chaque shapefile, les 4 extensions de fichier doivent être présentes: ".shp", ".dbf", ".prj", ".shx".',
				'La projection doit être une des suivantes:',
				' - WGS84 / UTM Zone 30N (EPSG:32630)',
				' - WGS84 / UTM Zone 29N (EPSG:32629)'
			...
			'import_shp_error_pattern_parcel': 'Aucun shapefile de polygone trouvé avec le nom commençant par "Parcel_"',
			'import_shp_error_pattern_parcel_point': 'Aucun shapefile de point trouvé avec le nom commençant par "Parcel_bor"',
			'import_shp_error_pattern_village': 'Aucun shapefile de polygone trouvé avec le nom commençant par "Terroir_"',
			'import_shp_error_pattern_village_point': 'Aucun shapefile de point trouvé avec le nom commençant par "Terroir_bor"',
