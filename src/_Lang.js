Ext.define('Ck._Lang', {
	...
	strings: {
        'en': {
			...
			'validate_the_parcel_no_spatial_unit_type_land': " No.",
			'validate_the_parcel_no_spatial_unit_type_village': " No.",
			'validate_the_parcel_in_parcel_no_spatial_unit_type_land': " in Parcel No. ",
			'validate_the_parcel_in_parcel_no_spatial_unit_type_village': " in Village No. ",
			'validate_parcel_need_mini_3_points': ' need at least 3 points',
			'validate_parcel_attribute_not_defined': ' has undefined attribute "{0}"',
			...
			'validate_point_dangle': 'Point {0} {1} is dangle.',
			...
			'validate_segment_undefined_attribute': "Traverse {0} {1} has undefined attribute \"{2}\".",
			'validate_point_undefined_attribute': "Point {0} {1} has undefined attribute \"{2}\".",
			...
			'zoom_to_village': 'Zoom to village',
			'undo': 'Undo',
			'redo': 'Redo',
        ...
        'fr': {
			...
			'parcel': 'Parcelle',
			'parcels': 'Parcelles',
			'village': 'Territoire de Village',
			'villages': 'Territoires de Village',
			'points': 'Points',
			'traverses': 'Segments',
			...
			'validate_jobarea_contains_source_parcels_spatial_unit_type_village': "L'aire de travail doit contenir tous les territoires de village source.",
			'validate_the_parcel_spatial_unit_type_land': "La Parcelle",
			'validate_the_parcel_spatial_unit_type_village': "Le Territoire de Village",
			'validate_the_parcel_no_spatial_unit_type_land': " No.",
			'validate_the_parcel_no_spatial_unit_type_village': " No.",
			'validate_the_parcel_in_parcel_no_spatial_unit_type_land': " dans la Parcelle No. ",
			'validate_the_parcel_in_parcel_no_spatial_unit_type_village': " dans le Territoire de Village No. ",
			'validate_parcel_need_mini_3_points': ' nécessite au moins 3 points',
			'validate_parcel_attribute_not_defined': ' a son attribut "{0}" non défini',
			...
			'validate_parcel_mini_area_spatial_unit_type_village': "La superficie minimum d'un territoire de village est ",
			'validate_parcel_maxi_area_spatial_unit_type_land': "La superficie maximum d'une parcelle est ",
			'validate_parcel_maxi_area_spatial_unit_type_village': "La superficie maximum d'un territoire de village est ",
			...
			'validate_parcel_survey_area_equal_gis_area_spatial_unit_type_village':'La superficie de levé du territoire de village créé{0} ({1} ha) doit être approximativement la même (+/- {2}%) que la superficie SIG ({3} ha).',
			...
			'validate_parcel_legal_area_equal_gis_area_spatial_unit_type_village': 'La superficie légale du territoire de village créé{0} ({1} ha) doit être approximativement la même (+/- {2}%) que la superficie SIG ({3} ha).',
			...
			'validate_parcel_legal_area_equal_survey_area_spatial_unit_type_village': 'La superficie légale du territoire de village créé{0} ({1} ha) doit être approximativement la même (+/- {2}%) que la superficie de levé ({3} ha).',
			...
			'validate_parcel_overlap_accuracy_n_spatial_unit_type_village': 'Le territoire de village{0} chevauche le village No.{2}.',
			'validate_parcel_not_in_jobarea_spatial_unit_type_land': "La parcelle{0} croise ou est en-dehors de l'aire de travail.",
			'validate_parcel_not_in_jobarea_spatial_unit_type_village': "Le territoire de village{0} croise ou est en-dehors de l'aire de travail.",
			'validate_parcel_overlap_otherlayer_spatial_unit_type_land': "La parcelle{0} chevauche d'autre couches: ",
			'validate_parcel_overlap_otherlayer_spatial_unit_type_village': "Le territoire de village{0} chevauche d'autre couches: ",
			'validate_point_not_snapped': "Le Point {0} n'est pas accroché (point à proximité) {1}.",
			'validate_point_dangle': 'Le Point {0} {1} est dans le vide.',
			'validate_parcel_in_district_spatial_unit_type_land': 'La parcelle{0} doit être dans "{1}" District mais chevauche "{2}".',
			'validate_parcel_in_district_spatial_unit_type_village': 'Le territoire de village{0} doit être dans le district "{1}" mais chevauche "{2}".',
			'validate_parcel_in_county_spatial_unit_type_land': 'La parcelle{0} doit être dans "{1}" County mais chevauche "{2}".',
			'validate_parcel_in_county_spatial_unit_type_village': 'Le territoire de village{0} doit être dans le County "{1}" mais chevauche "{2}".',
			'validate_parcel_zonal_office_spatial_unit_type_land': 'La parcelle{0} doit être dans le pays (ou minimum 50% de la superficie).',
			'validate_parcel_zonal_office_spatial_unit_type_village': 'Le territoire de village{0} doit être dans le pays (ou minimum 50% de la superficie).',
			...
			'validate_parcel_zonal_office_2_spatial_unit_type_village': 'Le territoire de village{0} doit être dans le pays mais seulement {2}% du territoire de village chevauche.',
			...
			'validate_parcel_zonal_office_3_spatial_unit_type_village': 'Le territoire de village{0} doit être dans le pays mais seulement {2}% du territoire de village chevauche (minimum 50%).',
			'validate_segment_undefined_attribute': "Le segment {0} {1} a son attribut \"{2}\" non défini.",
			'validate_point_undefined_attribute': "Le point {0} {1} a son attribut \"{2}\" non défini.",
			...
			'validate_source_parcel_area_gis_incorrect_union_spatial_unit_type_village': 'La superficie SIG du territoire de village créé ({0} ha) doit être égale à la somme des superficies SIG des territoires de village sources ({1} ha).',
			...
			'validate_source_parcel_area_gis_incorrect_fusion_spatial_unit_type_village': 'La somme des superficies SIG des territoires de village créés ({0} ha) doit être égale à la superficie SIG du territoire de village source ({1} ha).',
			...
			'validate_source_parcel_area_survey_incorrect_union_spatial_unit_type_village': 'La superficie de levé du territoire de village créé ({0} ha) doit être égale à la somme des superficies de levé des territoires de village sources ({1} ha).',
			...
			'validate_source_parcel_area_survey_incorrect_fusion_spatial_unit_type_village': 'La somme des superficies de levé des territoires de village créés ({0} ha) doit être égale à la superficie de levé du territoire de village source ({1} ha).',
			...
			'validate_source_parcel_area_legal_incorrect_union_spatial_unit_type_village': 'La superficie légale du territoire de village créé ({0} ha) doit être égale à la somme des superficies légales des territoires de village sources ({1} ha).',
			...
			'validate_source_parcel_area_legal_incorrect_fusion_spatial_unit_type_village': 'La somme des superficies légales des territoires de villages créés ({0} ha) doit être égale à la superficie légale du territoire de village source ({1} ha).',
			'zoom_to_parcel': 'Zoomer sur la parcelle',
			'zoom_to_village': 'Zoomer sur le territoire de village',
			'undo': 'Annuler',
			'redo': 'Rétablir',
