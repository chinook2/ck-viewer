...
//        this.exportPanel = this.createExportPanel();
    ...
    createExportPanel: function(opt) {
        var typesExports = [
            ["Points","Points"],
            ["Lignes","Lignes"],
            ["Polygones","Polygones"],
	    ...
	    var comboExport =  Ext.create('Ext.form.field.ComboBox', {
            ...
            value: opt ? opt.police : 'Points',
            mode: 'local',
            displayField:'display',
            triggerAction: 'all',
            selectOnFocus:true
        });
        //comboExport.setValue(opt.police);
	...
	onWinRender: function(cmp) {
		this.toolbar = Ext.create({
			...
			items: [{
				action: "ckmapDrawPoint",
				win: cmp,
				objprt: this
			},{
				action: "ckmapDrawLine",
				win: cmp,
				objprt: this
			},{
				action: "ckmapDrawCircle",
				win: cmp,
				objprt: this
			},{
				action: "ckmapDrawPolygon",
				win: cmp,
				objprt: this
			},{
				action: "ckmapDrawText",
				win: cmp,
				objprt: this
			},"->",{
				action: "ckmapDrawClear",
				win: cmp
			},{
				action: "ckmapDrawModify",
				win: cmp,
				choicePanel: this.modifyPanel
			},{
				action: "ckmapDrawExport",
				win: cmp
			}]
		});
